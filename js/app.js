 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".bestsellers__slider")) new core(".bestsellers__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        da.init();
        let search = document.querySelector(".header__icon._icon-search");
        let searchInp = document.querySelector(".input.header__input");
        search.addEventListener("click", (function() {
            searchInp.classList.toggle("_active");
        }));
        let whitescreen = document.querySelector(".wrapper");
